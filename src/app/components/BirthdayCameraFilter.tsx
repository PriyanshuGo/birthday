...
export const BirthdayCameraFilter = forwardRef<BirthdayCameraFilterRef, BirthdayCameraFilterProps>(
  ...
  const runDemoAnimation = () => {
    ...
    const animate = () => {
      ...
      // Draw the birthday cake overlay on top
      drawBirthdayCake(ctx, faceX, faceY - 80, 180, candlesLit, frame);
      ...
      if (videoRef.current && canvasRef.current && videoRef.current.readyState === 4) {
        ...
        if (ctx) {
          ...
          if (faces.length > 0) {
            ...
            drawBirthdayCake(ctx, noseTip.x, noseTip.y - eyeDistance * 0.8, eyeDistance * 1.5, candlesLit, Date.now());
          }
        }
      }
